...
const catalogSeed: CatalogItem[] = [
  ...
  catalogItem("SOAP-01", "Handmade Soap Bar", "toiletries", "Kama Ayurveda", "100 g", 60, 95, "guest_soap", "Noida Essentials"),
  catalogItem("SHAMP-01", "Shampoo 50ml", "toiletries", "Biotique", "50 ml", 45, 75, "guest_shampoo", "Noida Essentials"),
  ...
  catalogItem("KIT-01", "Welcome Kit — Premium", "bundle", "Comfort Curators", "1 kit", 900, 1_400, "welcome_kit", "Noida Essentials", "owner_preferred"),
  ...
  catalogItem("BEDSET-01", "Queen Comforter Bedding Set (Dark Grey)", "linen", "Comfort Curators", "1 set", 1_560, 2_200, "queen_bedding", "Noida Textiles", "alternative"),
  catalogItem("BEDSP-01", "Quilted Bedspread (Dark Purple)", "linen", "Comfort Curators", "1 bedspread", 1_070, 1_500, "queen_bedding", "Noida Textiles", "alternative"),
  ...
  catalogItem("ARTIFPLANT-01", "Artificial Trailing Ivy Wall Greenery", "decor", "Comfort Curators", "1 piece", 1_280, 1_800, "artificial_plants", "Noida Decor"),
  catalogItem("ARTIFPLANT-02", "Artificial Willow Branch Vine Garland", "decor", "Comfort Curators", "1 garland", 670, 950, "artificial_plants", "Noida Decor"),
  catalogItem("ARTIFPLANT-03", "Artificial Potted Plants (8-Pack)", "decor", "Comfort Curators", "8 pcs", 850, 1_200, "artificial_plants", "Noida Decor"),
  catalogItem("ARTIFPLANT-04", "Artificial Succulent Cactus Pots (4-Piece)", "decor", "Comfort Curators", "4 pcs", 460, 650, "artificial_plants", "Noida Decor"),
  catalogItem("ARTIFPLANT-05", "Artificial Eucalyptus Potted Plants (6-Pack)", "decor", "Comfort Curators", "6 pcs", 780, 1_100, "artificial_plants", "Noida Decor"),
  catalogItem("RUG-01", "Fish Print Fringed Rug", "decor", "Comfort Curators", "1 rug", 1_280, 1_800, "rugs", "Noida Textiles"),
  catalogItem("TAPESTRY-01", "Medieval Cat Musical Tapestry", "decor", "Comfort Curators", "1 tapestry", 850, 1_200, "wall_decor", "Noida Decor"),
  catalogItem("TAPESTRY-02", "Mountain Lake Forest Wall Tapestry", "decor", "Comfort Curators", "1 tapestry", 850, 1_200, "wall_decor", "Noida Decor"),
  ...
  catalogItem("PLANTER-01", "Wall-Mounted Glass Pothos Planter", "decor", "Comfort Curators", "1 planter", 320, 450, "planters", "Noida Decor"),
  catalogItem("WALLO-01", "Botanical Fabric Wall Organizer", "decor", "Comfort Curators", "1 organizer", 460, 650, "wall_decor", "Noida Decor"),
  catalogItem("MACRAME-01", "Macrame Hanging Plant Holders Set", "decor", "Comfort Curators", "1 set", 270, 380, "planters", "Noida Decor"),
  catalogItem("SIDETBL-01", "Mango Wood Round Side Table (Black)", "furniture", "Comfort Curators", "1 table", 1_990, 2_800, "side_tables", "Noida Woodworks"),
  ...
  catalogItem("PLANTSH-01", "Corner Wooden Plant Shelves", "furniture", "Comfort Curators", "1 shelf", 2_280, 3_200, "plant_shelves", "Noida Woodworks", "owner_preferred"),
  catalogItem("PLANTSH-02", "Freestanding Wooden Plant Display Shelf", "furniture", "Comfort Curators", "1 shelf", 1_990, 2_800, "plant_shelves", "Noida Woodworks", "owner_preferred"),
  catalogItem("PLANTSH-03", "Tall Multi-Tier Wooden Plant Stand", "furniture", "Comfort Curators", "1 stand", 1_280, 1_800, "plant_shelves", "Noida Woodworks"),
  catalogItem("HOOK-01", "Brushed Gold Four Wall Hooks", "furniture", "Comfort Curators", "4 hooks", 200, 280, "wall_hooks", "Noida Decor"),
  catalogItem("LAMP-02", "Brown Pleated Floor Lamp", "furniture", "Comfort Curators", "1 lamp", 1_560, 2_200, "floor_lighting", "Noida Decor"),
  catalogItem("LAMP-03", "Silver Arc Floor Lamp", "furniture", "Comfort Curators", "1 lamp", 2_700, 3_800, "floor_lighting", "Noida Decor", "owner_preferred"),
...
async function seedProperties() {
  step("Seeding and activating two Noida properties");
    ...
    if (!property) {
      property = await request<Resource<PropertyData>>("/v1/properties", {
        ...
        body: {
          ...
          emergency_contacts: [
            {
              name: "Comfort Curators Noida Desk",
